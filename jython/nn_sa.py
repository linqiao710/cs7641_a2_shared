...
def main(learningRate, fname, CE):
    """Run this experiment"""
    ...
    train(oa, classification_network, 'SA', training_ints, measure, TRAINING_ITERATIONS, fname)
...
if __name__ == "__main__":
    ...
    CE_list = [0.35, 0.55, 0.70, 0.95]
    for learningRate, CE in product([0.00064], CE_list):
        fname = OUTFILE.format('SA', 'SA_{}_{}'.format("CE", CE), str(1))
        with open(fname, 'w') as f:
            f.write(
                '{},{},{},{},{}\n'.format('iterations', 'loss', 'acc_trg', 'f1_trg', 'time'))

        main(learningRate, fname, CE)
