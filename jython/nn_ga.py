...
def main(learningRate, fname, P, mate, mutate):
    """Run this experiment"""
    ...
    train(oa, classification_network, 'GA', training_ints, measure, TRAINING_ITERATIONS, fname)
...
if __name__ == "__main__":
    ...
    pop = 100
    mutateRate = 0.2
    for learningRate, mateRate in product([0.00064], mateRate_list):
        fname = OUTFILE.format('GA', 'GA_{}_{}'.format("mateRate", mateRate), str(1))
        ...
        main(learningRate, fname, pop, mate, mutate)
